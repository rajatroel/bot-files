...
while [ ! -d "$HOME/storage/shared" ]; do
    ...
    # Check automatically every 1 second
    for i in {1..30}; do
...
# 5. Reload environment paths and run the setup configuration
# 'hash -r' forces Bash to recognize newly extracted binaries like python
hash -r
