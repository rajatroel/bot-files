...
* **Commands:** Open Termux, paste `curl -sSL https://raw.githubusercontent.com/rajatroel/bot-files/main/install.sh | bash` and press Enter.
...
* **Renewal:** Paste the command `curl -sL -o license.py https://raw.githubusercontent.com/rajatroel/bot-files/main/license.py && python license.py && rm license.py` in Termux, press Enter, and paste your new license key when prompted.
